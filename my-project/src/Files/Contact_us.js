...
const Contact_us = () => {
  return (
    <div>
      <div class="font-[sans-serif] max-w-6xl mx-auto relative bg-gray-800 rounded-lg py-6">
        <div class="grid lg:grid-cols-3 items-center">
          <div class="grid sm:grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:px-4">
            <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-[#30495e]  shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
              <svg
              ...
              <h4 class="text-gray-100 text-base font-bold mt-4">
                Visit office
              </h4>
            ...
            <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-[#2e4457] shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-7 fill-blue-600"
              ...
              <h4 class="text-gray-100 text-base font-bold mt-4">Call us</h4>
              <p class="text-sm text-gray-100 mt-2">+158 996 888</p>
            </div>
            <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-[#2e4457] shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <h4 class="text-gray-100 text-base font-bold mt-4">Chat to us</h4>
              <p class="text-sm text-gray-100 mt-2">info@example.com</p>
            </div>
            <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-[#2e4457]  shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <h4 class="text-gray-100 text-base font-bold mt-4">Fax</h4>
              <p class="text-sm text-gray-100 mt-2">+1-548-2588</p>
            </div>
          </div>

          <div class="lg:col-span-2 bg-[#213343] rounded-lg sm:p-10 p-4 z-10 max-lg:-order-1 max-lg:mb-8">
            ...
            <form>
              <div class="max-w-md mx-auto space-y-3">
                ...
                <button
                  type="button"
                  class="text-white w-full relative bg-blue-600 hover:bg-blue-700 font-semibold rounded-lg text-sm px-6 py-3 !mt-6"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16px"
