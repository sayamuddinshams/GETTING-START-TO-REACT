...
import about_img from "../Assets/Workers/about.jpg";

const About = () => {
  return (
    <div>
      <div class="font-sans">
        <div class="grid lg:grid-cols-2 items-center lg:gap-y-6 bg-[#213343] ">
          <div class="max-lg:order-1 max-lg:text-center sm:p-12 p-4">
            <h2 class="text-gray-100 lg:text-5xl text-3xl font-bold lg:!leading-[56px]">
              Why Choose us ?
            </h2>
            <p class="text-gray-100 mt-6 text-base leading-relaxed">
              "Choose us because we offer high-quality, handcrafted furniture
              tailored to your style. Our designs are unique, durable, and
              locally crafted, ensuring both elegance and longevity. With
              exceptional customer service and a commitment to sustainability,
              we make your home beautiful while caring for the environment."
            </p>
            <button
              type="button"
              class="bg-blue-700  mt-12 transition-all text-gray-100 font-bold text-sm rounded-md px-6 py-2.5"
            >
              Explore
            </button>
          </div>
          ...
          <div class="lg:h-[480px] flex items-center">
            <img
              src={about_img}
              class="w-full h-full object-cover p-10 rounded-full"
        ...
        <div class="grid lg:grid-cols-4 md:grid-cols-2 gap-6 px-4 my-12">
          <div class="bg-[#213343]  p-6 rounded-md">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="#007bff"
              class="w-10 h-10 mb-4 inline-block bg-white p-2 rounded-md"
              viewBox="0 0 32 32"
            >
              <path
            ...
            <h3 class="text-lg font-bold mb-2 text-gray-100">Customization</h3>
          ...
          <div class="bg-[#213343]  p-6 rounded-md">
            ...
            <h3 class="text-lg font-bold mb-2 text-gray-100">Support</h3>
            <p class="text-sm text-gray-100">
          ...
          <div class="bg-[#213343]  p-6 rounded-md">
            ...
            <h3 class="text-lg font-bold mb-2 text-gray-100">Performance</h3>
            <p class="text-sm text-gray-100">
          ...
          <div class="bg-[#213343]  p-6 rounded-md">
            ...
            <h3 class="text-lg font-bold mb-2 text-gray-100">Security</h3>
            <p class="text-sm text-gray-100">
